    ...
    <div className="max-w-6xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        ...
        <div className="flex gap-4">
           ...
           <div className="surface px-4 py-2 rounded-xl border border-emerald-500/20 bg-emerald-500/5">
          ...
          <div className="space-y-6">
            ...
            <div className="grid gap-4">
              {postsWithIssues.map((post) => (
                <div key={post.id} className="surface rounded-2xl p-5 border border-white/5 hover:border-white/10 transition">
                  <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
                    ...
                    <Link
                      ...
                      className="inline-flex items-center justify-center px-4 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white text-sm font-medium transition shrink-0"
                    >
                      Fix Now
